...
class Image2PublisherNode(Node):

    def __init__(self):
        super().__init__('image2_publisher_node')
        ...
        self.image_path = os.path.join(package_share_directory, 'images', 'test1.jpeg')
